...
class PaymentRecordPolicy
{
    ...
    {
                                return $user->hasPermission('PaymentRecord_access');
    ...
    {
                                return $user->hasPermission('PaymentRecord_show');
    ...
    {
                                return $user->hasPermission('PaymentRecord_create');
    ...
    {
                                return $user->hasPermission('PaymentRecord_edit');
    ...
    {
                                return $user->hasPermission('PaymentRecord_delete');

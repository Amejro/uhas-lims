...
class ProducerPolicy
{
    ...
    {
                                                return $user->hasPermission('Producer_access');
    ...
    {
                                                return $user->hasPermission('Producer_show');
    ...
    {
                                                return $user->hasPermission('Producer_create');
    ...
    {
                                                return $user->hasPermission('Producer_edit');
    ...
    {
                                                return $user->hasPermission('Producer_delete');
